  ...
  class FileUpload { 
    ...
    public function __construct($option = null){
      if($option==null){
        /*加载默认配置*/
        $this->path = "uploads";
        $this->allowtype = array('jpg','gif','png');
        $this->maxsize = 1000000; 
        $this->israndname = true;
      }else{
        $this->path = isset($option['path'])?$option['path']:'uploads';
        $this->allowtype = isset($option['allowtype'])?$option['allowtype']:array('jpg','gif','png');
        $this->maxsize = isset($option['maxsize'])?$option['maxsize']:1000000; 
        $this->israndname = isset($option['israndname'])?$option['israndname']:true;
      }
    }
